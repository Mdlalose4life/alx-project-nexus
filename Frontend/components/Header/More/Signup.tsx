...
const Signup: React.FC = () => {
    return (
        <div className="relative">
                <div className="flex flex-col absolute top-full left-1/2 -translate-x-1/2 mt-2 z-50 bg-[#EDECFE] text-black p-4 rounded-xl gap-1">
                    <div className="border border-gray-300 rounded-2xl px-[2px] py-[2px]">
                        <input 
                            type="text"
                            placeholder="Email: "
                            className="text-sm lg:text-md w-[100px] lg:w-[200px] outline-none"/>
                    </div>
