...
const Login: React.FC= () => {
    return (
        <div className="relative">
                <div className="flex flex-col absolute top-full left-1/2 -translate-x-[93%] w-[230px] lg:w-[220px] mt-2 z-50 bg-[#EDECFE] text-black p-4 rounded-xl gap-1">
                    <div className="border border-gray-300 rounded-2xl px-[4px] py-[4px]">
                        <input 
                            type="text"
                            placeholder="Email:"
                            className="text-md w-[190px] rounded-lg lg:w-[150px] outline-none"/>
                    </div>
                    <div className="border border-gray-300 rounded-2xl px-[4px] py-[4px]">
                        <input 
                            type="text"
