...
const RightSideNav: React.FC<ActiveProps> = ({topOffset}) => {
    ...
    return (
        <div>
            ...
            >
                <div className="border bg-[#c2c0f5] border-[#ececec] rounded-r-xl h-[70%] p-5">
                ...
                <div className="mt-4 border bg-[#c2c0f5] border-[#ececec] rounded-r-xl  h-[30%] p-5">
